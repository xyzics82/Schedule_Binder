(function () {
    ...
    return `
      <div class="full-grid">
        <section class="panel sheet">
          <div class="panel-header">
            <div>
              <h2 class="panel-title">탭별 사용 설명서</h2>
              <p class="panel-subtitle">흐름: 수집함에 던져두기 → 주간에 시간 배치 → 오늘에서 실행·기록 → 통계로 돌아보기. 각 탭을 펼치면 언제·어떻게 쓰는지와 실제 예시가 나옵니다.</p>
            </div>
          </div>
          <div class="panel-body">
            ${renderTabGuideDetails()}
          </div>
        </section>
        <section class="panel sheet">
          <div class="panel-header">
  ...
  function renderTabGuideDetails() {
    const guides = [
      {
        tab: "주간",
        tagline: "한 주의 시간 설계 — 일요일 15분이 일주일을 만든다",
        when: "일요일 저녁 또는 월요일 아침 15분(계획) + 매일 저녁 5분(Do 덮어쓰기)",
        how: [
        ...
        examples: [
          ...
          "Plan: 목 19:00–20:00 「자전거 로라 1시간」 / 토 08:00–11:00 「주말 라이딩」",
          "주간 체크박스: 「금요일까지 학회 초록 제출」, 「과제 정산서류 행정실 전달」",
          "Don't forget 칸: 「수요일 수아 학교 상담 15:00」"
        ],
        tip: "계획 블록은 하루 6시간까지만. 나머지는 회의·돌발 일이 채웁니다. 계획을 다 지키는 주가 이상한 주입니다."
      },
      {
        tab: "오늘",
        ...
        examples: [
          "체크박스: 「리뷰어 코멘트 회신」 「수아 수학 문제집 2쪽」 「장비 교정 신청」",
          "메모: 「반응온도 180→175℃로 변경, 수율 미세 상승. 다음엔 170℃ 시도」",
          "회고: 「오전 분석 몰입 좋았음. 오후 회의가 길어져 논문 읽기 밀림 → 내일 아침 첫 블록으로 이동.」"
        ],
        tip: "체크박스가 7개를 넘으면 이미 실패한 목록입니다. 넘치는 것은 수집함으로 보내세요."
      },
      {
        tab: "월간",
        tagline: "큰 흐름과 마감 — 세부 계획 말고 굵직한 날짜만",
        when: "매월 1일 10분 + 새 마감이 생길 때마다 즉시",
        how: [
          "과제 보고서·논문·학회 마감, 출장, 휴가, 가족 행사(아이 방학·학교 행사)를 입력합니다.",
          "세부 할 일은 넣지 않습니다 — 그건 연구 탭과 주간 탭의 몫입니다.",
          "주간 계획을 세우기 전에 항상 월간을 먼저 봅니다. 마감 2주 전부터 주간 탭에 준비 블록이 나타나야 정상입니다."
        ],
        examples: [
          "「7/15 OO과제 중간보고서 마감」 「7/22–24 추계학회(부산)」",
          "「8/1 아이들 방학 시작」 「8/15 논문 리비전 마감」 「8/20 가족 여행」"
        ],
        tip: "마감일이 아니라 '내 마감'을 적으세요. 공식 마감 7/15이면 7/12로 — 마지막 3일은 늘 다른 일이 터집니다."
      },
      {
        tab: "수집함",
        tagline: "3초 캡처 — 판단은 나중에, 지금은 적기만",
        when: "떠오르는 순간 즉시. 비우기는 주간 계획 때 한 번에",
        how: [
          "한 줄 쓰고 종류만 고르고 끝. 어디에 넣을지, 언제 할지 고민하지 않습니다 — 고민하는 순간 캡처가 아니라 일이 됩니다.",
          "실험 중, 회의 중, 라이딩 후 샤워하다 떠오른 것 전부 여기로. 폰에서는 하단 탭바로 바로 엽니다.",
          "일요일 주간 계획 때 하나씩 처리: 계속 관리할 일이면 「연구로」 승격 / 시간이 필요하면 주간 Plan 블록 / 금방 끝나면 오늘 체크박스 / 아니면 삭제.",
          "처리한 항목은 ✓로 접어둡니다."
        ],
        examples: [
          "아이디어: 「전처리 온도 5℃ 낮춰 재현성 확인해볼 것」",
          "읽을 논문: 「Kim 2026 촉매 안정성 리뷰 — 초록만이라도」",
          "아이·가족: 「수아 분수 어려워함 → 시각 교구 알아보기」",
          "할 일: 「연구실 안전교육 이수 신청」"
        ],
        tip: "머리는 아이디어를 만드는 곳이지 보관하는 곳이 아닙니다. 적는 순간 잊어도 되는 자유가 생깁니다."
      },
      {
        tab: "연구",
        tagline: "과제·실험·논문·발표 — 마감과 '다음 행동'만 살아 있으면 굴러간다",
        when: "새 일이 시작될 때 항목 추가 + 주 1회(주간 계획 직전) 점검",
        how: [
          "돌아가는 일 단위 하나당 항목 1개: 과제 보고서 1건, 논문 원고 1편, 실험 세트 1개, 발표 1건.",
          "마감을 넣으면 D-day 배지가 자동으로 붙고 임박하면 색이 바뀝니다.",
          "핵심은 '다음 행동' 한 줄 — 지금 당장 시작할 수 있는 다음 한 걸음을 항상 적어둡니다. 하나가 끝나면 그 자리에서 다음 것으로 교체합니다. 막힐 때 이 줄만 보고 시작하면 됩니다.",
          "세부 할 일은 항목 안 체크박스로, 몰입 시간이 필요한 것은 주간 탭에서 Plan 블록으로 시간을 확보합니다."
        ],
        examples: [
          "[과제·보고서] 「OO과제 연차보고서」 D-9 · 다음 행동: 「성과 요약표 초안 작성」 · 할 일: 예산 집행률 확인, 그림 3개 업데이트",
          "[논문 작성] 「촉매 안정성 원고」 · 다음 행동: 「Fig.2 재작성 (리뷰어 2 지적)」",
          "[실험·분석] 「시료 2차 분석 세트」 · 다음 행동: 「전처리 조건표 확정」",
          "[학회·발표] 「추계학회 포스터」 D-16 · 다음 행동: 「결과 그래프 4개 선정」"
        ],
        tip: "'다음 행동'은 15분 안에 시작할 수 있는 크기로. 「논문 쓰기」(막막함) 대신 「서론 문헌 3편 요약」(시작 가능)."
      },
      {
        tab: "루틴",
        tagline: "매주 반복 — 완벽보다 연속, 강도보다 꾸준함",
        when: "활동이 끝난 직후 바로 체크 (몰아서 체크하면 잊습니다)",
        how: [
        ...
        examples: [
          "🚴 자전거 타기 · 주 3회 (출퇴근 라이딩 포함)",
          "📖 아이들과 공부 · 주 5회 (저녁 식후 30분, 책 읽기·수학 번갈아)",
          "📄 논문·자료 읽기 · 주 5회 (출근 직후 30분, 메일 열기 전에)",
      ...
      },
      {
        ...
        tip: "숫자가 나쁜 주에도 기록을 멈추지 마세요. 나쁜 주의 데이터가 가장 값진 데이터입니다."
      }
    ];
    return `
      <div class="guide-tab-details">
        ${guides.map((guide, idx) => `
          <details class="guide-tab-detail" ${idx === 0 ? "open" : ""}>
            <summary>
              <span class="tag guide-tab-tag">${esc(guide.tab)}</span>
              <span class="guide-tab-tagline">${esc(guide.tagline)}</span>
            </summary>
            <div class="guide-tab-body">
              <p class="guide-when"><em>언제</em>${esc(guide.when)}</p>
              <ol class="guide-how">
                ${guide.how.map((step) => `<li>${esc(step)}</li>`).join("")}
              </ol>
              <div class="guide-example">
                <em>예시</em>
                <ul>${guide.examples.map((example) => `<li>${esc(example)}</li>`).join("")}</ul>
              </div>
              <p class="guide-tip"><em>팁</em>${esc(guide.tip)}</p>
            </div>
          </details>
        `).join("")}
      </div>
